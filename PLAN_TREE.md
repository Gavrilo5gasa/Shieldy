...
# JF Presentation Angle

## Research Question
*"How much of everyday home network traffic is blocked by a self-built DNS filter,
and can pattern analysis of real traffic generate better blocklists than existing ones?"*

## What You Measure
- Total queries per day / week
- Blocked percentage by category (ads vs trackers vs malware)
- Top 10 most-blocked domains on your network
- False positive rate (legit sites accidentally blocked)
- Blocklist coverage: which list catches what the others miss?

## Your Original Contribution
`contrib/gen.py` — analyzes weeks of your own query logs and outputs a custom
blocklist tuned to your network's actual traffic. No one else has this data.
That's the part no one can copy, and the part judges will remember.
